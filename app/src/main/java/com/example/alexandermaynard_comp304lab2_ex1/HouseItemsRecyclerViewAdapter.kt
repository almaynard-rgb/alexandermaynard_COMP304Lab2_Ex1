...
internal class HouseItemsRecyclerViewAdapter(context: Context, private var houseTypeList: List<String>) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val houseType = houseTypeList[position]
        holder.houseTypeList.text = houseType
